...
# Install package
RUN apt update && apt install software-properties-common wget curl git openssh-client tmate python3-pip sudo neofetch -y && apt clean
...
EXPOSE 6080 5900 3389 3388 3001 3002 3003 80 443 25565
